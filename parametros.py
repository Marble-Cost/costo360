...
TOUR_PASOS = [
    {
        ...
        "cuerpo":   "Esta herramienta es de uso exclusivo de Mármoles Collante & Castro Ltda. y te ayuda a calcular el costo real de cualquier proyecto en piedra natural o sinterizado, y a generar cotizaciones y cuentas de cobro profesionales en segundos.\n\nEl recorrido guiado toma menos de 3 minutos y cubre todo lo que necesitas saber.",
        "pagina":   None,
    },
    {
