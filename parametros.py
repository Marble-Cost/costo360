...
TOUR_PASOS = [
    ...
    {
        "id":       "sobrantes",
        "etiqueta": "SOBRANTES APROVECHABLES",
        "icono":    "♻",
        "titulo":   "Convierte los sobrantes en ganancia",
        "cuerpo":   "Cada vez que apruebas una cotización que generó material sobrante, el sistema lo guarda automáticamente en 'Sobrantes Aprovechables'.\n\nCuando vayas a cotizar un proyecto nuevo con el mismo material, la app te avisará que tienes sobrante disponible. Usarlo puede eliminar el costo de material por completo y disparar tu margen al 80% o más.\n\nEn el Dashboard verás el 'Capital Inmovilizado Recuperable': el valor total de tus sobrantes al precio original de mercado.",
        "pagina":   "Dashboard",
    },
    {
        "id":       "pdf",
